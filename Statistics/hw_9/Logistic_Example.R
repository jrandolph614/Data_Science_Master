...
######### NOT APPLICABLE TO TO THIS DATA BY THIS LIBRARY #######

library(ResourceSelection)

hoslem.test(pnmc$Proportion.of.Severe.Cases,  fitted(lstc2), g=5)

library(MKmisc)

HLgof.test(fit = fitted(lstc), obs = pnmc$Proportion.of.Severe.Cases)

######### NOT APPLICABLE TO TO THIS DATA BY THIS LIBRARY #######

library(ResourceSelection)

hoslem.test(pnmc$Proportion.of.Severe.Cases,  fitted(lstc),g=8)
